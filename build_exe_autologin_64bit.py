...
def build_executable():
    ...
    pyinstaller_args = [
        'monitor-server-autologin-64bit.py',  # Fișierul principal
    ...
    try:
        ...
        print("\nIMPORTANT:")
        print("   - Executabilul CITESTE credențialele din VARIABILE DE MEDIU")
        print("   - Setează ALEPH_SERVER_IP, ALEPH_SSH_USER, ALEPH_SSH_PASS, etc.")
        print("   - Utilizator Catalog implicit: admin / admin123 (configurabil prin env vars)")
