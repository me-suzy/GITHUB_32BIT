# ALEPH Server Monitor - 32-bit Auto Login Version
...
def is_backup_window():
    ...
    return current_hour >= 22 or current_hour < 3
...
class AlephMonitorAutoLogin:
    def __init__(self):
        ...
        self.root = tk.Tk()
        self.root.title("Monitor Server ALEPH - Auto Login (32-bit)")
    ...
    def create_main_screen(self):
        ...
        subtitle_label = tk.Label(main_frame, text="Monitor Automat (32-bit)", font=("Arial", 12), fg="#7f8c8d")
        ...
        # Info despre restricțiile de timp
        time_info = tk.Label(main_frame,
                            text="⚠️ RESTRICȚII DE TIMP:\nAplicația NU rulează între 22:00 și 03:00 (pauză backup)",
                            font=("Arial", 9), fg="#e74c3c", justify=tk.CENTER)
        time_info.pack(pady=5)
    ...
    def create_monitor_screen(self):
        ...
        title_label = tk.Label(header_frame, text="🟢 Monitor Activ (32-bit)",
    ...
    def start_monitoring(self):
        ...
        if is_backup_window():
            messagebox.showwarning("Pauză Backup", 
                               "Monitorizarea este suspendată între 22:00 și 03:00 (pauză backup).")
        ...
        self.add_log("✓ Monitor pornit cu auto-login (32-bit)", "SUCCESS")
    ...
    def restart_server_sequence(self):
        ...
        try:
            ...
            # 4. Deschide catalog ONLINE în browser (ORDINE CRITICĂ: ÎNAINTE de Catalog.exe)
            ...
            # 5. Lansare Catalog.exe cu credențiale
    ...
    def manual_restart(self):
        ...
        if is_backup_window():
            messagebox.showwarning("Pauză Backup", 
                               "Repornirea este blocată între 22:00 și 03:00 (pauză backup).")
            return
